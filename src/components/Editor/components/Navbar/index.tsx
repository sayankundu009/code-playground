export default function Navbar() {
    return (
        <nav className="navbar bg-main text-neutral-content border-b border-gray-600">
            ...
            <div className="flex-none">
                <a className="btn btn-square btn-ghost" href="https://github.com/sayankundu009/code-playground" target="_blank">
